# TEMPORARILY COMMENTED OUT TO ALLOW SECRET IMPORTS - outputs.tf fails because service doesn't exist
...
#   min_instances       = (var.env == "dev" || var.env == "qa") ? 0 : 2
#   memory              = 2048
#   cpus                = 1
#   project_id          = var.app_project_id
# }

# Grant service account Cloud Run Invoker role in viki-stage-app-wsky project
# COMMENTED OUT: Service account does not exist
