locals {
  ...
  # pool_id       = "${local.name_prefix}-ado-mediwareis"
...
#   member             = "principal://iam.googleapis.com/projects/${var.mgmt_project_id}/locations/global/workloadIdentityPools/${local.pool_id}/subject/${local.ado_subject}"
# }
