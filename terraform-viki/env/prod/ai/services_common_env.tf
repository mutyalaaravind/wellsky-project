...
locals {
  ...
  common_env = {
    ...
    HHH_ATTACHMENTS_API                            = "https://api.prod-wsh.hhh-prod-app.prj.gcp.wellsky.io/"
    HHH_ATTACHMENTS_AUTH_SERVER                    = "https://auth.wellsky.io/connect/token"
    HHH_ATTACHMENTS_CLIENT_ID                      = "client.hhh.medication.genai.prod"
    ...
    MEDICATION_EXTRACTION_RESPAWN_INFLIGHT_ENABLED = "true"
