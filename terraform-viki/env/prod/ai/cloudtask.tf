...
resource "google_cloud_tasks_queue" "paperglass_classification_quarantine" {
  ...
  rate_limits {
    ...
    max_dispatches_per_second = var.cloudtask_paperglass_classification_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "paperglass_extraction_quarantine" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_quarantine_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_paperglass_extraction_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_extraction_entrypoint" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_extraction_entrypoint_default_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_extraction_entrypoint_priority" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_extraction_entrypoint_priority_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_extraction_entrypoint_quarantine" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_quarantine_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_extraction_entrypoint_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_status_check" {
  name     = "v4-status-check-default-queue-hack"
  location = var.region
  project  = var.app_project_id
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_max_concurrent_dispatches
...
resource "google_cloud_tasks_queue" "v4_status_check_quarantine" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_quarantine_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_status_check_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_paperglass_integration_status_update_quarantine" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_quarantine_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_paperglass_integration_status_update_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
...
resource "google_cloud_tasks_queue" "v4_paperglass_medications_integration_quarantine" {
  ...
  rate_limits {
    max_concurrent_dispatches = var.cloudtask_quarantine_max_concurrent_dispatches
    max_dispatches_per_second = var.cloudtask_v4_paperglass_medications_integration_quarantine_max_dispatches_per_second
  }
  retry_config {
    max_attempts       = 3
    max_retry_duration = "4s"
