...
# Grant summarization agents prod service account access to AI Platform
resource "google_project_iam_member" "summarization_agents_prod_ai_access" {
  project = var.app_project_id
  role    = "roles/aiplatform.admin"
  member  = "serviceAccount:summarization-agents-prod-sa@viki-prod-app-wsky.iam.gserviceaccount.com"
}

# Grant summarization agents prod service account Vertex AI user permissions
resource "google_project_iam_member" "summarization_agents_prod_vertex_ai_user" {
  project = var.app_project_id
  role    = "roles/aiplatform.user"
  member  = "serviceAccount:summarization-agents-prod-sa@viki-prod-app-wsky.iam.gserviceaccount.com"
}

# Grant sonny summarization agents prod service account Vertex AI user permissions
resource "google_project_iam_member" "sonny_summarization_agents_prod_vertex_ai_user" {
  project = var.app_project_id
  role    = "roles/aiplatform.user"
  member  = "serviceAccount:summarization-agents-prod-sa@sonny-prod-app-wsky.iam.gserviceaccount.com"
}

# Grant summarization agents prod service account ability to invoke Cloud Run services
resource "google_project_iam_member" "summarization_agents_prod_cloud_run_invoker" {
  project = var.app_project_id
  role    = "roles/run.invoker"
  member  = "serviceAccount:summarization-agents-prod-sa@viki-prod-app-wsky.iam.gserviceaccount.com"
}

# Grant summarization agents prod service account ability to read and write to Cloud Storage buckets
resource "google_project_iam_member" "summarization_agents_prod_storage_object_admin" {
  project = var.app_project_id
  role    = "roles/storage.objectAdmin"
  member  = "serviceAccount:summarization-agents-prod-sa@viki-prod-app-wsky.iam.gserviceaccount.com"
}

# Grant summarization agents prod service account access to Firestore DB
resource "google_project_iam_member" "summarization_agents_prod_firestore_access" {
  project = var.app_project_id
  role    = "roles/datastore.user"
  member  = "serviceAccount:summarization-agents-prod-sa@viki-prod-app-wsky.iam.gserviceaccount.com"
}
