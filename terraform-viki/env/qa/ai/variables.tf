...
variable "okta_admin_group_id" {
  description = "ID of the Okta admin group for role-based assignment"
  type        = string
}

variable "okta_regular_users_group_id" {
  description = "ID of the Okta regular users group for role-based assignment (managed by Admin UI)"
  type        = string
}

variable "okta_app_id" {
  description = "ID of the Okta APP application"
  type        = string
}
...
variable "autoscribe_api_url" {
  type = string
}

variable "autoscribe_widget_url" {
  type = string
}

variable "extract_and_fill_widget_url" {
  type = string
}

variable "paperglass_widget_url" {
  type = string
}

variable "paperglass_api_secondary_url" {
  type = string
}
