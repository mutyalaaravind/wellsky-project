...
# Grant service account Cloud Run Invoker role in viki-qa-app-wsky project
# Commented out - orphaned IAM binding for non-existent service account
# resource "google_project_iam_member" "service_account_run_invoker" {
#   project = "viki-qa-app-wsky"
