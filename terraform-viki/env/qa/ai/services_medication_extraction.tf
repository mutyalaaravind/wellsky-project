module "medication_extraction_api" {
  ...
  image                 = "${var.region}-docker.pkg.dev/${var.mgmt_project_id}/images/ai-medication_extraction:${var.paperglass_version}"
  command = [
    "uv", "run", "uvicorn", "main:app",
    "--host", "0.0.0.0",
    "--port", "8080",
    "--workers", tostring(var.cloud_run_services.medication_extraction_api.uvicorn_workers)
  ]
  env = {
  ...
  labels              = var.labels
  ingress             = "all"
  allow_public_access = var.cloud_run_services.medication_extraction_api.allow_public_access
  min_instances       = var.cloud_run_services.medication_extraction_api.min_instances
  max_instances       = var.cloud_run_services.medication_extraction_api.max_instances == "unlimited" ? null : var.cloud_run_services.medication_extraction_api.max_instances
  memory              = var.cloud_run_services.medication_extraction_api.memory
  cpus                = var.cloud_run_services.medication_extraction_api.cpus  
  concurrency         = var.cloud_run_services.medication_extraction_api.concurrency
  timeout             = var.cloud_run_services.medication_extraction_api.timeout  
}
...
module "medication_extraction_api_2" {
  ...
  command = [
    ...
    "--host", "0.0.0.0",
    "--port", "8080",
    "--workers", tostring(var.cloud_run_services.medication_extraction_api_2.uvicorn_workers),
  ]
  env = {
    SERVICE                                                      = "medication_extraction"
    STAGE                                                        = var.env
  ...
  labels              = var.labels
  ingress             = "all"
  allow_public_access = var.cloud_run_services.medication_extraction_api_2.allow_public_access
  min_instances       = var.cloud_run_services.medication_extraction_api_2.min_instances  
  max_instances       = var.cloud_run_services.medication_extraction_api_2.max_instances == "unlimited" ? null : var.cloud_run_services.medication_extraction_api_2.max_instances
  memory              = var.cloud_run_services.medication_extraction_api_2.memory
  cpus                = var.cloud_run_services.medication_extraction_api_2.cpus
  concurrency         = var.cloud_run_services.medication_extraction_api_2.concurrency
  timeout             = var.cloud_run_services.medication_extraction_api_2.timeout  
}
...
module "medication_extraction_default_api" {
  ...
  command = [
    ...
    "--host", "0.0.0.0",
    "--port", "8080",
    "--workers", tostring(var.cloud_run_services.medication_extraction_default_api.uvicorn_workers),
  ]
  env = {
    SERVICE                                                      = "medication_extraction"
    STAGE                                                        = var.env
  ...
  labels              = var.labels
  ingress             = "all"
  allow_public_access = var.cloud_run_services.medication_extraction_default_api.allow_public_access
  min_instances       = var.cloud_run_services.medication_extraction_default_api.min_instances
  max_instances       = var.cloud_run_services.medication_extraction_default_api.max_instances == "unlimited" ? null : var.cloud_run_services.medication_extraction_default_api.max_instances
  memory              = var.cloud_run_services.medication_extraction_default_api.memory
  cpus                = var.cloud_run_services.medication_extraction_default_api.cpus
  concurrency         = var.cloud_run_services.medication_extraction_default_api.concurrency
  timeout             = var.cloud_run_services.medication_extraction_default_api.timeout  
}
...
module "medication_extraction_high_api" {
  ...
  command = [
    ...
    "--host", "0.0.0.0",
    "--port", "8080",
    "--workers", tostring(var.cloud_run_services.medication_extraction_high_api.uvicorn_workers),
  ]
  env = {
    SERVICE                                                      = "medication_extraction"
    STAGE                                                        = var.env
  ...
  labels              = var.labels
  ingress             = "all"
  allow_public_access = var.cloud_run_services.medication_extraction_high_api.allow_public_access
  min_instances       = var.cloud_run_services.medication_extraction_high_api.min_instances
  max_instances       = var.cloud_run_services.medication_extraction_high_api.max_instances == "unlimited" ? null : var.cloud_run_services.medication_extraction_high_api.max_instances
  memory              = var.cloud_run_services.medication_extraction_high_api.memory
  cpus                = var.cloud_run_services.medication_extraction_high_api.cpus
  concurrency         = var.cloud_run_services.medication_extraction_high_api.concurrency
  timeout             = var.cloud_run_services.medication_extraction_high_api.timeout  
}
...
module "medication_extraction_quarantine_api" {
  ...
  command = [
    ...
    "--host", "0.0.0.0",
    "--port", "8080",
    "--workers", tostring(var.cloud_run_services.medication_extraction_quarantine_api.uvicorn_workers),
  ]
  env = {
    SERVICE                                                      = "medication_extraction"
    STAGE                                                        = var.env
  ...
  labels              = var.labels
  ingress             = "all"
  allow_public_access = var.cloud_run_services.medication_extraction_quarantine_api.allow_public_access
  min_instances       = var.cloud_run_services.medication_extraction_quarantine_api.min_instances
  max_instances       = var.cloud_run_services.medication_extraction_quarantine_api.max_instances == "unlimited" ? null : var.cloud_run_services.medication_extraction_quarantine_api.max_instances
  memory              = var.cloud_run_services.medication_extraction_quarantine_api.memory
  cpus                = var.cloud_run_services.medication_extraction_quarantine_api.cpus
  concurrency         = var.cloud_run_services.medication_extraction_quarantine_api.concurrency
  timeout             = var.cloud_run_services.medication_extraction_quarantine_api.timeout  
}
