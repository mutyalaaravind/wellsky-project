...
OKTA_PAPERGLASS_CLIENT_ID = getenv_or_die('OKTA_PAPERGLASS_CLIENT_ID')
OKTA_PAPERGLASS_CLIENT_SECRET = getenv_or_die('OKTA_PAPERGLASS_CLIENT_SECRET')
OKTA_PAPERGLASS_SCOPE = getenv_or_die('OKTA_PAPERGLASS_SCOPE')
OKTA_PAPERGLASS_TOKEN_ISSUER_URL = getenv_or_die('OKTA_PAPERGLASS_TOKEN_ISSUER_URL')
