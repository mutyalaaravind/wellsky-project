(function() {
    'use strict';
    angular
        .module('directives.kinnser.am-print-view.page-builder-new', [
            ...
            'directives.kinnser.am-print-view.page-new',
    ...
    .constant('Envi', {
        ...
        .directive('kPageBuilderNew', kPageBuilderNew);

        kPageBuilderNew.$inject = ['Envi'];

    function kPageBuilderNew(Envi) {
        return {
            templateUrl: Envi.envi + "directives/page-builder/page-builder2.tpl.html",
            restrict: "EA",
            controller: ['$scope', 'pageBuilderService', PageBuilderContoller2],
            scope: {
                data: "=printModel",
                idSuffix: '@?',
                isPrintView: '=?',
    ...
    function PageBuilderContoller2($scope, pageBuilderService) {
