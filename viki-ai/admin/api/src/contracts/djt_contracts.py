"""
Distributed Job Tracking Contracts

This module defines the contract (port) for DJT operations in the Admin API.
"""
...
class DJTPort(ABC):
    ...
    and follows the hexagonal architecture pattern.
    """
