...
const LLMModelsTab: React.FC = () => {
  ...
  // Permission checks
  const canAdd = hasPermission('admin.settings.llmmodels.action.add')
  const canEdit = hasPermission('admin.settings.llmmodels.action.edit')
  const canDelete = hasPermission('admin.settings.llmmodels.action.delete')
